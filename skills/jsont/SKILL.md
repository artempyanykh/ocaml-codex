---
name: jsont
description: "JSON type-safe encoding and decoding using the OCaml jsont library. Use when Codex needs to: define typed JSON codecs for OCaml record types, parse JSON strings to OCaml values, or serialize OCaml values to JSON, or work with nested JSON structures"
---
