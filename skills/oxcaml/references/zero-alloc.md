...
See also: [references/stack-allocation.md](references/stack-allocation.md) for local allocation,
[references/unboxed.md](references/unboxed.md) for unboxed types.
