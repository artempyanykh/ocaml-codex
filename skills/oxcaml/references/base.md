...
- [references/modes.md](references/modes.md) - Detailed mode system documentation
- [references/stack-allocation.md](references/stack-allocation.md) - Stack allocation patterns
- [references/templates.md](references/templates.md) - ppx_template usage and mangling
- [references/core.md](references/core.md) - Core library OxCaml extensions
