...
See also: [references/stack-allocation.md](references/stack-allocation.md) for locality details,
[references/uniqueness.md](references/uniqueness.md) for uniqueness patterns.
